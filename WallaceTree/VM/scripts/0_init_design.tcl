...
set rtl_list { FA.v ripple.v CSA.v products.v mulTree.v multiply.v}
#set rtl_list { FA_32.v}
#set rtl_list { Mux1bit.v Mux8.v Mux23.v FullAdder.v  RightShifter.v SubtractionStage.v   demo_carrySelectAdder.syn.v Complement2s8bit.v FinalOutput.v FloatingPointAdder.v}
#set rtl_list { overflow.v FullAdder.v RippelCarryAdder.v  CarrySaveAdder.v}
#set rtl_list { overflow.v FullAdder.v RippelCarryAdder.v }
#set rtl_list { overflow.v NormalAdder.v }
#set rtl_list { overflow.v bitAdder.v CLA4bit.v CLA32bit.v}
#set rtl_list { overflow.v mux.v FA.v CarrySkipAdderInterface.v RCA8bit.v CSA32bit.v}
#set rtl_list { overflow.v halfAdder.v FullAdder.v RCA16.v CaryyIncrementAdder.v}
#set rtl_list { overflow.v mux_2x1.v FullAdder.v carry_bypass_4_bit.v carry_bypass_adder.v}
#set rtl_list { overflow.v Mux2x1.v FullAdder.v RCA16.v carrySelectAdder.v}
